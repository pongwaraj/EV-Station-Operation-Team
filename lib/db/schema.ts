...
export const stations = pgTable(
  "stations",
  {
    ...
    longitude: numeric("longitude", { precision: 12, scale: 7 }),
    latitude: numeric("latitude", { precision: 12, scale: 7 }),
    customerName: text("customer_name"),
    acChargerCount: integer("ac_charger_count"),
    dcChargerCount: integer("dc_charger_count"),
    acOnlineCount: integer("ac_online_count"),
    dcOnlineCount: integer("dc_online_count"),
    totalPowerKw: numeric("total_power_kw", { precision: 12, scale: 4 }),
    onlineDate: date("online_date", { mode: "string" }),
...
export const chargers = pgTable(
  "chargers",
  {
    ...
    powerKw: numeric("power_kw", { precision: 12, scale: 4 }),
    chargerModel: text("charger_model"),
    country: text("country"),
    city: text("city"),
    mcuVersion: text("mcu_version"),
    ccuVersion: text("ccu_version"),
    status: text("status"),
    onlineDate: date("online_date", { mode: "string" }),
    lastHeartbeatRaw: text("last_heartbeat_raw"),
